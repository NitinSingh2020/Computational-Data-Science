...
print collision_prob(1000, 50) # Problem 1
print collision_prob(1000, 200) # Problem 2
print observe_prob(1000, 50, 1000) # Problem 3
print observe_prob(1000, 200, 1000) # Problem 4
print collision_prob(365, 30) # Problem 5
print collision_prob(365, 250) # Problem 6
# Problem 7
for i in range(1000):
